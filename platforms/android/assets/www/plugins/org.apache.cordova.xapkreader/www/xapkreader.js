cordova.define("org.apache.cordova.xapkreader.XAPKReader", function(require, exports, module) { var exec = require("cordova/exec");
...
module.exports = {
    ...
    extract: function(filename, successCallback, errorCallback, fileType) {
        // only for android
        if (!navigator.userAgent.match(/Android/i)) {
            return successCallback(filename);
        }
        ...
        if (null === filename) {
            console.error("XAPKReader.extract failure: filename parameter needed");
            return;
        }
        ...
        cordova.exec(success, errorCallback, "XAPKReader", "extract", [filename]);
    },
