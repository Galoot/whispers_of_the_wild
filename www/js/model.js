...
function Model() {
    ...
    var _get_animals = "SELECT a.animalID, idPointers, name, thumbName, commonNames, score, iconFilePath, category FROM ANM_Animal a, ANM_Profile p WHERE a.animalID = p.animalID ORDER BY name ASC";
